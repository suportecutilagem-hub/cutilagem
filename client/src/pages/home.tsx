        ...
        <div className="container mx-auto px-4 text-center">
          <AnimatedSection>
            <div className="grid grid-cols-2 gap-2 max-w-xs mx-auto">
              <div className="bg-green-500 text-white px-1 py-0.5 rounded text-sm font-semibold shadow-md flex items-center justify-center gap-1">
              ...
              <div className="bg-green-500 text-white px-1 py-0.5 rounded text-sm font-semibold shadow-md flex items-center justify-center gap-1 col-span-2">
